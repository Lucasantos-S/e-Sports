import { AlignTop, GameController, MagnifyingGlassPlus } from "phosphor-react";
...
function App() {
  ...
  React.useEffect(() => {
    async function fetchApi() {
      const api = await fetch("http://localhost:3333/games");
          ...
          <form className="mt-8 flex flex-col gap-4">
            ...
            <div className="flex gap-6 ">
              ...
              <div className="flex flex-col gap-2 flex-1">
                <label htmlFor="hoursStart">Quando horário do dia?</label>
